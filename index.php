...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if (isset($_POST["pesquisar"])) {
        $a = $prodController->pesquisarProduto($_POST["pesquisar"]);
    }
}
...
<body>
    ...
    <header class="navbar">
        ...
        <nav class="nav-links">
            <a href="index.php" class="nav-item active"><i class="ri-medicine-bottle-line"></i> Produtos</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display: flex; gap: 0.5rem;">
                                    ...
                                    <a href="index.php?excluir=<?= $produto->id ?>" class="btn-action btn-delete" title="Excluir" onclick="return confirm('Deseja excluir este produto?')"><i class="ri-delete-bin-line"></i></a>
                                </div>
                            </td>
                        </tr>
                    <?php 
